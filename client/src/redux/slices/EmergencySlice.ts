...
export const fetchAllEmergencies = createAsyncThunk(
    "emergency/fetchAll",
    async () => {
        const response = await axios.get("https://dummy-repo-jk6d.onrender.com/emergency");
...
export const fetchSingleEmergency = createAsyncThunk(
    ...
    async (id: string, thunkAPI) => {
        try {
            const response = await axios.get(`https://dummy-repo-jk6d.onrender.com/emergency/${id}`);
...
export const updateEmergencyStatus = createAsyncThunk(
    ...
    async ({ id, newEmergency }:{id:string, newEmergency:Emergency}, thunkAPI) => {
        try {
            const response = await axios.patch(`https://dummy-repo-jk6d.onrender.com/emergency/${id}`, { newEmergency });
            return response.data.emergency;
        } catch (e) {
            return thunkAPI.rejectWithValue(e);
        }
...
export const createEmergency = createAsyncThunk(
    ...
    async (emergency: Emergency, thunkAPI) => {
        try {
            const response = await axios.post("https://dummy-repo-jk6d.onrender.com/emergency", emergency);
            return response.data.emergency;
        } catch (e) {
            return thunkAPI.rejectWithValue(e);
        }
